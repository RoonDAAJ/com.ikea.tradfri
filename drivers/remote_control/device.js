...
class RemoteControl extends ZigBeeDevice {
	...
	onMeshInit() {
		...
		this.registerReportListener('genOnOff', 'off', this.switchOff.bind(this));
		this.registerReportListener('genOnOff', 'on', this.switchOn.bind(this));
		this.registerReportListener('genOnOff', 'toggle', this.toggle.bind(this));

		this.registerReportListener('genLevelCtrl', 'stop', this.doLevelCtrl.bind(this));
		this.registerReportListener('genLevelCtrl', 'stopWithOnOff', this.doLevelCtrl.bind(this));
		this.registerReportListener('genLevelCtrl', 'moveToLevelWithOnOff', this.doLevelCtrl.bind(this));
